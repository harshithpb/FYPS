			...
			<div class="body-container">
			  ...
			  <br>
				...
				<form action="<?=$_SERVER['PHP_SELF'];?>" alt ="SaveFaculty" method="post" > 
					...
					<tr><td>FACULTY NAME</td><td><br><Input type="text" name="FacultyName" value="<?php if (isset($GLOBALS['vFacultyName'])){ echo $vFacultyName; }?>" readonly > <br><br></td></tr> 
					<tr><td>FACULTY ADDR</td><td><br><Input type="text" name="FacultyAddr" value="<?php if (isset($GLOBALS['vFacultyAddr'])) { echo $vFacultyAddr; } ?>" readonly><br><br> </td></tr>
					<tr><td>FACULTY CONTACT</td><td><br><Input type="text" name="FacultyContact" value="<?php if (isset($GLOBALS['vFacultyContact'])) { echo $vFacultyContact;} ?>" readonly><br><br></td></tr>
					<tr><td>FACULTY EMAILID</td><td><br><Input type="text" name="Facultyemailid" value="<?php if (isset($GLOBALS['vFacultyemailid'])) { echo $vFacultyemailid; } ?>" readonly><br><br></td></tr>
					<tr><td>FACULTY DEPTMT</td><td><br><Input type="text" name="Facultydeptmt" value="<?php if (isset($GLOBALS['vFacultydeptmt'])) { echo $vFacultydeptmt; } ?>" readonly ><br><br></td></tr>
					</table>
					<br>
