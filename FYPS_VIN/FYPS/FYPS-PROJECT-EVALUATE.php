       ...
       <body>
		...
		<?php
			...
			function Save_Project()
			{
				...
				$sql = $sql . " fyps_project_grade = ".'"'.$vGrade.'"';
		...
		?>      
			...
			<div class="body-container">
			  <center>
				...
				<form action="<?=$_SERVER['PHP_SELF'];?>" alt ="SaveProject" method="post" > 
					...
					<br><br><br></table><br>
					PROJECT GRADE: <select id="input_15" name="grade" style="width:80px" data-component="dropdown" required=""><center>
            <option value="">  </option>
            <option value="A+"> A+ </option>
            <option value="A"> A </option>
            <option value="B+"> B+ </option>
            <option value="B"> B </option>
            <option value="C"> C </option></center>
          </select>
					<br><br>
          ...
          <div class="fixed-footer"><center>
              <div class="container">2018 DBIT</div> </center>       
          </div>
