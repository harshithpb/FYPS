       ...
       <body>
		...
		<?php
			...
			if (!$conn)
				...
				$sql = "select fyps_project_id, fyps_project_title, fyps_project_domain ,fyps_project_department,fyps_project_grade from fyps_project"; 
