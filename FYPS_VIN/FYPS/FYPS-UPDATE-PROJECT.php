   ...
   <html lang="en-US>
       <head>
	    <!-- below line external style sheet  --> 
		  ...
		  <title>FYPS UPDATE PROJECT</title> 
	   </head>
       <body>
		...
		<?php
			...
			function Save_Project()
			{
				...
				if ($result === TRUE)
				{
						echo "<script type='text/javascript'>alert(' FYPS_PROJECT...Updated Successfully...');</script>";
				}
				else
				{
						echo "<script type='text/javascript'>alert('$sql');</script>";
			...
			<div class="body-container">
			  ...
			  <br>
				...
				<form action="<?=$_SERVER['PHP_SELF'];?>" alt ="SaveProject" method="post" > 
					...
					<tr><td>PROJECT TITLE</td><td><br><Input type="text" name="ProjectTitle" value="<?php if (isset($GLOBALS['vProjectTitle'])){ echo $vProjectTitle; }?>" > <br><br> </td></tr>
					<tr><td>PROJECT DOMAIN</td><td><br><Input type="text" name="ProjectDomain" value="<?php if (isset($GLOBALS['vProjectDomain'])) { echo $vProjectDomain; } ?>"><br><br></td></tr> 
					<tr><td>PROJECT DEPTMt</td><td><br><Input type="text" name="ProjectDeptmt" value="<?php if (isset($GLOBALS['vProjectdeptmt'])) { echo $vProjectdeptmt;} ?>"><br><br></td></tr>
