   ...
   <html lang="en-US>
       <head>
	    <!-- below line external style sheet  --> 
		  ...
		  <title>VIEW PROJECT_TO_FACULTY</title> 
	   </head>
       <body>
	    ...
	    <div class="fixed-header">
            <div class="container">
				...
				<h2> <center>VIEW PROJECT_TO_FACULTY</center> </h2>
				<button type="button" onclick= "location.href='FYPS-ADMIN.html'" id = "ADMIN_HOME" >HOME</button>
				<button type="button" onclick= "location.href='FYPS-ASSIGNMENT.html'" id = "ASSIGNMENT_HOME" >ASSIGNMENT HOME</button>
		...
		<?php
			...
			if (!$conn)
				...
				$sql = "select faculty_id,project_id,project_name from fyps_faculty_project";
			//echo $sql;
