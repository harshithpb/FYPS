   ...
   <html lang="en-US>
       <head>
	    <!-- below line external style sheet  --> 
		  ...
		  <title>FYPS DELETE STUDENT</title> 
	   </head>
       <body>
		...
		<?php
			...
			//	$vStudentDepartment= $_POST["StudentDepartment"];
				...
				$sql = "delete from fyps_student ";
				//$sql = $sql . " fyps_student_first_name = ".'"'.$vStudentFirstName.'"'.",fyps_student_last_name = //".'"'.$vStudentLastName.'"'." ,  fyps_student_age = ".'"'.$vStudentAge.'"';
				//$sql = $sql . " ,fyps_project_title = ".'"'.$vStudentProjectTitle.'"'.", fyps_student_address = ".'"'.$vStudentAddr.'"'.", fyps_student_contact = ".'"'.$vStudentContact.'"'." ,fyps_student_emailid = ".'"'.$vstudentemailid.'"';
			...
			//	$sql = $sql . " ,fyps_faculty_department = ".'"'.$vFacultydeptmt.'"';
				$sql = $sql . " where fyps_user_id = ".'"'.$vStudentId.'"';
		...
		?>      
          ...
          <div class="fixed-header">
            <div class="container">
				...
				<h2> <center>STUDENT - DELETE</center> </h2>
