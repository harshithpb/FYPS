			...
			<div class="body-container">
			  ...
			  <hr>
				...
				<form action="<?=$_SERVER['PHP_SELF'];?>" alt ="SaveFaculty" method="post" > 
					...
					FACULTY Name: <Input type="text" name="FacultyName" value="<?php if (isset($GLOBALS['vFacultyName'])){ echo $vFacultyName; }?>" > <br><br> 
					FACULTY Addr: <Input type="text" name="FacultyAddr" value="<?php if (isset($GLOBALS['vFacultyAddr'])) { echo $vFacultyAddr; } ?>"><br><br> 
					FACULTY Contact: <Input type="text" name="FacultyContact" value="<?php if (isset($GLOBALS['vFacultyContact'])) { echo $vFacultyContact;} ?>"><br><br>
					FACULTY emailid: <Input type="text" name="Facultyemailid" value="<?php if (isset($GLOBALS['vFacultyemailid'])) { echo $vFacultyemailid; } ?>"><br><br>
					FACULTY Deptmt: <Input type="text" name="Facultydeptmt" value="<?php if (isset($GLOBALS['vFacultydeptmt'])) { echo $vFacultydeptmt; } ?>" ><br><br>
					<hr>
