			...
			<div class="body-container">
			  ...
			  <hr>
				...
				<form action="<?=$_SERVER['PHP_SELF'];?>" alt ="SaveProject" method="post" > 
					...
					PROJECT Title: <Input type="text" name="ProjectTitle" value="<?php if (isset($GLOBALS['vProjectTitle'])){ echo $vProjectTitle; }?>" > <br><br> 
					PROJECT Domain: <Input type="text" name="ProjectDomain" value="<?php if (isset($GLOBALS['vProjectDomain'])) { echo $vProjectDomain; } ?>"><br><br> 
					PROJECT Deptmt: <Input type="text" name="ProjectDeptmt" value="<?php if (isset($GLOBALS['vProjectdeptmt'])) { echo $vProjectdeptmt;} ?>"><br><br>
